...
from PyQt5.QtWidgets import QApplication, QFileDialog, QLabel, QMainWindow, QPushButton, QDialog
from PyQt5.QtGui import QPixmap

class SeleccionArchivoVentana(QDialog):
    def __init__(self):
        super().__init__()
